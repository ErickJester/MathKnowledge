...
// Ruta al directorio de uploads para Calculo
$dir = __DIR__ . '/../uploads/Calculo/libros';
...
<body>
  ...
  <nav class="sidebar">
    ...
    <ul>
      ...
      <li><a href="calculo_videos.php"><span>🎥</span><span class="label">Vídeos</span></a></li>
      <li class="active"><a href="calculo_libros.php"><span>📖</span><span class="label">Libros</span></a></li>
      <li><a href=""><span>✏️</span><span class="label">Ejercicios</span></a></li>
      <li><a href=""><span>📝</span><span class="label">Exámenes</span></a></li>
  ...
  <div class="content">
    ...
    <div class="subject-nav">
      <ul class="subject-menu">
        <li class="dropdown">
          <a href="calculo_videos.php">Analisis Vectorial ▾</a>
          <ul class="dropdown-content">
            <li><a href="analisis_vectorial_videos.php">Vídeos</a></li>
            <li><a href="analisis_vectorial_libros.php">Libros</a></li>
            <li><a href="calculo_ejercicios.php">Ejercicios</a></li>
            <li><a href="calculo_examenes.php">Exámenes</a></li>
          </ul>
        </li>
        <li class="dropdown">
